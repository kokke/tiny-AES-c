...
//
// TINY_AES_CBC enables AES encryption in CBC-mode of operation.
// TINY_AES_CTR enables encryption in counter-mode.
...
#else
    #error "You need to specify a key size between AES128, AES192 or AES256."
#endif
...
#if TINY_AES_USE_RAM
// Call this function to initialize the lookup-tables in ram
