...
// Enable ECB, CBC and CTR mode. Note this can be done before including aes.h or at compile-time.
// E.g. with GCC by using the -D flag: gcc -c aes.c -DCBC=0 -DECB=1 -DCTR=0
#define CBC 1
#define ECB 1
#define CTR 1
...
static void test_ctr(void)
{
    /*
        ...
        key = binascii.a2b_hex('2b7e151628aed2a6abf7158809cf4f3c')
        iv = binascii.a2b_hex('f0f1f2f3f4f5f6f7f8f9fafbfcfdfeff')
        plain = binascii.a2b_hex('6bc1bee22e409f96e93d7e117393172aae2d8a571e03ac9c9eb76fac45af8e5130c81c46a35ce411e5fbc1191a0a52eff69f2445df4f9b17ad2b417be66c3710')
        cipher = binascii.a2b_hex('874d6191b620e3261bef6864990db6ce9806f66b7970fdff8617187bb9fffdff5ae4df3edbd5d35e5b4f09020db03eab1e031dda2fbe03d1792170a0f3009cee')
    ...
    */
    ...
    uint8_t plain[64] = { 0x6b, 0xc1, 0xbe, 0xe2, 0x2e, 0x40, 0x9f, 0x96, 0xe9, 0x3d, 0x7e, 0x11, 0x73, 0x93, 0x17, 0x2a,
                        0xae, 0x2d, 0x8a, 0x57, 0x1e, 0x03, 0xac, 0x9c, 0x9e, 0xb7, 0x6f, 0xac, 0x45, 0xaf, 0x8e, 0x51,
                        0x30, 0xc8, 0x1c, 0x46, 0xa3, 0x5c, 0xe4, 0x11, 0xe5, 0xfb, 0xc1, 0x19, 0x1a, 0x0a, 0x52, 0xef,
                        0xf6, 0x9f, 0x24, 0x45, 0xdf, 0x4f, 0x9b, 0x17, 0xad, 0x2b, 0x41, 0x7b, 0xe6, 0x6c, 0x37, 0x10 };
    uint8_t cipher[64] = { 0x87, 0x4d, 0x61, 0x91, 0xb6, 0x20, 0xe3, 0x26, 0x1b, 0xef, 0x68, 0x64, 0x99, 0x0d, 0xb6, 0xce,
                         0x98, 0x06, 0xf6, 0x6b, 0x79, 0x70, 0xfd, 0xff, 0x86, 0x17, 0x18, 0x7b, 0xb9, 0xff, 0xfd, 0xff,
                         0x5a, 0xe4, 0xdf, 0x3e, 0xdb, 0xd5, 0xd3, 0x5e, 0x5b, 0x4f, 0x09, 0x02, 0x0d, 0xb0, 0x3e, 0xab,
                         0x1e, 0x03, 0x1d, 0xda, 0x2f, 0xbe, 0x03, 0xd1, 0x79, 0x21, 0x70, 0xa0, 0xf3, 0x00, 0x9c, 0xee };
    uint8_t buffer[64];
    
    AES128_CTR_process_buffer(buffer, plain, 64, key, iv);
    
    printf("CTR encrypt: ");
    
    if (0 == memcmp((char *) cipher, (char *) buffer, 64))
    {
      printf("SUCCESS!\n");
    }
    else
    ...
    AES128_CTR_process_buffer(buffer, cipher, 64, key, iv);
    
    printf("CTR decrypt: ");
    
    if (0 == memcmp((char *) plain, (char *) buffer, 64))
    {
      printf("SUCCESS!\n");
    }
    else
