...
static void test_ctr(void)
{
    ...
    */
    ...
    uint8_t plain[] = { 0x6b, 0xc1, 0xbe, 0xe2, 0x2e, 0x40, 0x9f, 0x96, 0xe9, 0x3d, 0x7e, 0x11, 0x73, 0x93, 0x17, 0x2a,
                        ...
                        0x30, 0xc8, 0x1c, 0x46, 0xa3, 0x5c, 0xe4, 0x11, 0xe5, 0xfb, 0xc1, 0x19, 0x1a, 0x0a, 0x52, 0xef,
                        0xf6, 0x9f, 0x24, 0x45, 0xdf, 0x4f, 0x9b, 0x17, 0xad, 0x2b, 0x41, 0x7b, 0xe6, 0x6c, 0x37, 0x10 };
    uint8_t cipher[] = { 0x87, 0x4d, 0x61, 0x91, 0xb6, 0x20, 0xe3, 0x26, 0x1b, 0xef, 0x68, 0x64, 0x99, 0x0d, 0xb6, 0xce,
                         0x98, 0x06, 0xf6, 0x6b, 0x79, 0x70, 0xfd, 0xff, 0x86, 0x17, 0x18, 0x7b, 0xb9, 0xff, 0xfd, 0xff,
                         0x5a, 0xe4, 0xdf, 0x3e, 0xdb, 0xd5, 0xd3, 0x5e, 0x5b, 0x4f, 0x09, 0x02, 0x0d, 0xb0, 0x3e, 0xab,
                         0x1e, 0x03, 0x1d, 0xda, 0x2f, 0xbe, 0x03, 0xd1, 0x79, 0x21, 0x70, 0xa0, 0xf3, 0x00, 0x9c, 0xee };
    size_t length = sizeof(plain) / sizeof(uint8_t);
    uint8_t buffer[length];
    
    AES128_CTR_process_buffer(buffer, plain, length, key, iv);
    
    printf("CTR encrypt: ");
    
    if (0 == memcmp((char *) buffer, (char *) cipher, length))
    {
      printf("SUCCESS!\n");
    }
    else
    ...
    AES128_CTR_process_buffer(buffer, cipher, length, key, iv);
    
    printf("CTR decrypt: ");
    
    if (0 == memcmp((char *) buffer, (char *) plain, length))
    {
      printf("SUCCESS!\n");
    }
    else
